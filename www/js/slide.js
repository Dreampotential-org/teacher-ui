...
function nextSlide(){
    ...
    $.ajax({
        "url": API_SERVER +"/course_api/flashcard/response/",
        'data': JSON.stringify(data_),
        'type': 'POST',
        'contentType': 'application/json',
        'success': function (data){
            $.ajax({
                "url": API_SERVER + '/course_api/session/event/' + flashcard_id + '/' + sessionId + '/',
...
function get_session() {
    ...
    $.get(API_SERVER + '/course_api/session/get', function (resp) {
        console.log(resp)
...
function init() {
    ...
    $.get(API_SERVER + '/course_api/lesson/read/' + lesson_id,
          function (response) {
